...
function responsiveVideoIframes(){
	 $('iframe[data-aspectRatio]').each(function() {
		...
		/* si el padre es 0 es porque existe un display none, para el caso de componente acordeon buscamos el padre del titulo*/
		 if(newWidth == 0 ){
			newWidth = $(this).parent().parent().parent().parent().width();
		 }
